...
CREATE TABLE `detail` (
  ...
  `d_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  KEY `idx_category_department_account_project` (`c_id`,`dep_id`,`a_id`,`p_id`) USING BTREE
...
-- Dump completed on 2020-10-15 20:26:54
