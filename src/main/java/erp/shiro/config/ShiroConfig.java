...
public class ShiroConfig {
    ...
    public ShiroFilterChainDefinition shiroFilterChainDefinition() {
        ...
        shiroFilterChainDefinition.addPathDefinition("/detail/add", "roles[admin]");
        shiroFilterChainDefinition.addPathDefinition("/detail/add", "roles[user]");
        shiroFilterChainDefinition.addPathDefinition("/detail/update*", "roles[admin]");
        shiroFilterChainDefinition.addPathDefinition("/detail/update*", "roles[user]");
        shiroFilterChainDefinition.addPathDefinition("/detail/delete", "roles[admin]");
        shiroFilterChainDefinition.addPathDefinition("/detail/delete", "roles[user]");
        shiroFilterChainDefinition.addPathDefinition("/setting/add*", "roles[admin]");
        shiroFilterChainDefinition.addPathDefinition("/setting/add*", "roles[user]");
        shiroFilterChainDefinition.addPathDefinition("/setting/update*", "roles[admin]");
